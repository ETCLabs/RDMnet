                                               ...
                                               const QModelIndex &index) const
{
  ...
  if (editorType == EditorWidgetType::EWT_COMBOBOX)
  {
...
void PropertyEditorsDelegate::setEditorData(QWidget *editor, const QModelIndex &index) const
{
  ...
  if ((comboBox != NULL) && (editorType == EditorWidgetType::EWT_COMBOBOX))
  {
    uint8_t personality = index.data(PersonalityPropertyValueItem::PersonalityNumberRole).toInt();
    QStringList descriptions = index.data(PersonalityPropertyValueItem::PersonalityDescriptionListRole).toStringList();
...
void PropertyEditorsDelegate::setModelData(QWidget *editor, QAbstractItemModel *model, const QModelIndex &index) const
{
  ...
  if ((comboBox != NULL) && (editorType == EditorWidgetType::EWT_COMBOBOX))
  {
    ...
    model->setData(index, personality, PersonalityPropertyValueItem::PersonalityNumberRole);
  }
  else
  {
