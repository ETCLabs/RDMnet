 ...
 */
typedef void (*RdmnetEptClientConnectedCallback)(rdmnet_ept_client_t              client_handle,
...
typedef void (*RdmnetEptClientClientListUpdateReceivedCallback)(rdmnet_ept_client_t        client_handle,
                                                                ...
                                                                const RdmnetEptClientList* client_list,
                                                                void*                      context);
...
typedef void (*RdmnetEptClientDataReceivedCallback)(rdmnet_ept_client_t    client_handle,
                                                    rdmnet_client_scope_t  scope_handle,
                                                    const RdmnetEptData*   data,
                                                    RdmnetSyncEptResponse* response,
                                                    void*                  context);
