 ...
 * \param[in] client_handle Handle to the EPT client which has connected.
 ...
 */
typedef void (*RdmnetEptClientConnectedCallback)(rdmnet_ept_client_t client_handle, rdmnet_client_scope_t scope_handle,
                                                 const RdmnetClientConnectedInfo* info, void* context);

/*!
 * \brief A connection attempt failed between an EPT client and a broker.
 * \param[in] client_handle Handle to the EPT client which has failed to connect.
 ...
 * \param[in] context Context pointer that was given at the creation of the client instance.
 */
typedef void (*RdmnetEptClientConnectFailedCallback)(rdmnet_ept_client_t client_handle,
 ...
 * \param[in] client_handle Handle to the EPT client which has disconnected.
 ...
 * \param[in] context Context pointer that was given at the creation of the client instance.
 */
typedef void (*RdmnetEptClientDisconnectedCallback)(rdmnet_ept_client_t client_handle,
                                                    rdmnet_client_scope_t scope_handle,
                                                    const RdmnetClientDisconnectedInfo* info, void* context);

/*!
 * \brief A client list update has been received from a broker.
 * \param[in] client_handle Handle to the EPT client which has received the client list update.
 ...
 * \param[in] context Context pointer that was given at the creation of the client instance.
 */
typedef void (*RdmnetEptClientClientListUpdateReceivedCallback)(rdmnet_ept_client_t client_handle,
                                                                rdmnet_client_scope_t scope_handle,
 ...
 * \param[in] client_handle Handle to the EPT client which has received the data.
 ...
 * \param[in] context Context pointer that was given at the creation of the client instance.
 */
typedef void (*RdmnetEptClientDataReceivedCallback)(rdmnet_ept_client_t client_handle,
                                                    rdmnet_client_scope_t scope_handle, const RdmnetEptData* data,
                                                    RdmnetSyncEptResponse* response, void* context);

/*!
 * \brief An EPT status message has been received in response to a previously-sent EPT data message.
 * \param[in] client_handle Handle to the EPT client which has received the EPT status message.
 ...
 * \param[in] context Context pointer that was given at the creation of the client instance.
 */
typedef void (*RdmnetEptClientStatusReceivedCallback)(rdmnet_ept_client_t client_handle,
                                                      rdmnet_client_scope_t scope_handle, const RdmnetEptStatus* status,
                                                      void* context);
