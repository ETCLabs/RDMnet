...
#define RDMNET_VERSION_BUILD 8 /**< The build number. */
/**
 * @}
 */
 ...
 * @{
 */
#define RDMNET_VERSION_STRING "0.4.0.8" /**< The version number as a string. */
#define RDMNET_VERSION_DATESTR "11.Aug.2022" /**< The date this version was created. */
