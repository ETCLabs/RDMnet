 ...
 */
typedef void (*RdmnetDeviceConnectedCallback)(rdmnet_device_t                  handle,
 ...
 * @param[in] context Context pointer that was given at the creation of the device instance.
 */
typedef void (*RdmnetDeviceConnectFailedCallback)(rdmnet_device_t                      handle,
 ...
 * @param[in] context Context pointer that was given at the creation of the device instance.
 */
typedef void (*RdmnetDeviceDisconnectedCallback)(rdmnet_device_t                     handle,
 ...
 * @param[in] context Context pointer that was given at the creation of the device instance.
 */
typedef void (*RdmnetDeviceRdmCommandReceivedCallback)(rdmnet_device_t         handle,
 ...
 * @param[in] context Context pointer that was given at the creation of the device instance.
 */
typedef void (*RdmnetDeviceLlrpRdmCommandReceivedCallback)(rdmnet_device_t        handle,
 ...
 * @param[in] context Context pointer that was given at the creation of the device instance.
 */
typedef void (*RdmnetDeviceDynamicUidStatusCallback)(rdmnet_device_t                       handle,
...
typedef struct RdmnetPhysicalEndpointResponder
{
  /** The responder's UID. */
  RdmUid uid;
  ...
  /**
   * @brief The binding UID received in the DISC_MUTE message from this responder.
   * @details Set to all 0's if no binding UID was received.
   */
  RdmUid binding_uid;
