...
typedef void (*RdmnetControllerClientListUpdateReceivedCallback)(rdmnet_controller_t        controller_handle,
                                                                 ...
                                                                 const RdmnetRptClientList* client_list,
                                                                 void*                      context);
...
{
  /****************************************************************************
   * These items do not have default values from the config initializer
   ***************************************************************************/
  ...
  /****************************************************************************
   * These items have default values from the config initializer
   ***************************************************************************/
   ...
   * Initialized to E120_PRODUCT_CATEGORY_CONTROL_CONTROLLER by default.
   */
  uint16_t product_category;
  /**
   * @brief Whether the library should allow the device_label to be changed remotely.
   * @details Initialized to false by default.
   */
  bool device_label_settable;
} RdmnetControllerRdmData;

/**
 * @brief A default-value initializer for an RdmnetControllerRdmData struct.
 *
 * Usage:
 * @code
 * RdmnetControllerRdmData config = RDMNET_CONTROLLER_RDM_DATA_DEFAULT_INIT;
