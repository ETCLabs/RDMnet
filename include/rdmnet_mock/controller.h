...
DECLARE_FAKE_VOID_FUNC(rdmnet_controller_set_callbacks,
                       ...
                       void*);
DECLARE_FAKE_VOID_FUNC(rdmnet_controller_set_rdm_data,
                       RdmnetControllerConfig*,
                       const char*,
                       const char*,
                       const char*,
                       const char*,
                       bool);
DECLARE_FAKE_VOID_FUNC(rdmnet_controller_set_rdm_cmd_callbacks,
                       RdmnetControllerConfig*,
