...
protected:
  ...
  rdmnet::RdmResponseAction ProcessDefRespRdmCommand(const rdm::CommandHeader& cmd,
                                                     const uint8_t*            data,
                                                     uint8_t                   data_len);
  ...
  void HandleNewRdmResponderDiscovered(unsigned int         gadget_id,
  ...
  void HandleRdmResponse(unsigned int    gadget_id,
                         unsigned int    port_number,
                         const RDM_CmdC& response,
                         const void*     cookie) override;
  void HandleRdmTimeout(unsigned int    gadget_id,
                        unsigned int    port_number,
