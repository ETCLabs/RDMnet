...
/* GET COMMANDS */
void get_identify_device(const uint8_t*         param_data,
                         uint8_t                param_data_len,
                         RdmnetSyncRdmResponse* response,
                         uint8_t*               response_buf);
void get_device_label(const uint8_t*         param_data,
                      uint8_t                param_data_len,
                      RdmnetSyncRdmResponse* response,
                      uint8_t*               response_buf);
void get_component_scope(const uint8_t*         param_data,
                         uint8_t                param_data_len,
                         RdmnetSyncRdmResponse* response,
                         uint8_t*               response_buf);
void get_search_domain(const uint8_t*         param_data,
                       uint8_t                param_data_len,
                       RdmnetSyncRdmResponse* response,
                       uint8_t*               response_buf);
void get_supported_parameters(const uint8_t*         param_data,
                              uint8_t                param_data_len,
                              RdmnetSyncRdmResponse* response,
                              uint8_t*               response_buf);
void get_device_info(const uint8_t*         param_data,
                     uint8_t                param_data_len,
                     RdmnetSyncRdmResponse* response,
                     uint8_t*               response_buf);
void get_manufacturer_label(const uint8_t*         param_data,
                            uint8_t                param_data_len,
                            RdmnetSyncRdmResponse* response,
                            uint8_t*               response_buf);
void get_device_model_description(const uint8_t*         param_data,
                                  uint8_t                param_data_len,
                                  RdmnetSyncRdmResponse* response,
                                  uint8_t*               response_buf);
void get_software_version_label(const uint8_t*         param_data,
                                uint8_t                param_data_len,
                                RdmnetSyncRdmResponse* response,
                                uint8_t*               response_buf);
...
void default_responder_set(uint16_t               pid,
...
void default_responder_get(uint16_t               pid,
                           const uint8_t*         param_data,
                           uint8_t                param_data_len,
                           RdmnetSyncRdmResponse* response,
                           uint8_t*               response_buf)
