...
static const std::vector<std::string> kLogFileDirComponents = {".local", "share", "rdmnet-examples"};
...
bool LinuxBrokerLog::Startup(int log_mask)
{
...
etcpal::LogTimestamp LinuxBrokerLog::GetLogTimestamp()
{
  time_t cur_time;
  time(&cur_time);
