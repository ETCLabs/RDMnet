...
DEFINE_FAKE_VALUE_FUNC(etcpal_error_t, rdmnet_disc_platform_start_monitoring, RdmnetScopeMonitorRef*, int*);
DEFINE_FAKE_VOID_FUNC(rdmnet_disc_platform_stop_monitoring, RdmnetScopeMonitorRef*);
DEFINE_FAKE_VALUE_FUNC(etcpal_error_t, rdmnet_disc_platform_register_broker, RdmnetBrokerRegisterRef*, int*);
...
DEFINE_FAKE_VOID_FUNC(monitorcb_broker_updated, rdmnet_scope_monitor_t, const RdmnetBrokerDiscInfo*, void*);
...
DEFINE_FAKE_VOID_FUNC(regcb_other_broker_found, rdmnet_registered_broker_t, const RdmnetBrokerDiscInfo*, void*);
DEFINE_FAKE_VOID_FUNC(regcb_other_broker_lost, rdmnet_registered_broker_t, const char*, const char*, void*);
