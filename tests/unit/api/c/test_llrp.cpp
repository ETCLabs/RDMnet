...
TEST(TestLlrpApi, ComponentTypeToString)
{
  ...
  EXPECT_NE(llrp_component_type_to_string(static_cast<llrp_component_t>(INT_MAX)), nullptr);
  EXPECT_NE(llrp_component_type_to_string(static_cast<llrp_component_t>(-1)), nullptr);
}
