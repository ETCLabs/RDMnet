...
FAKE_VOID_FUNC(handle_ept_client_connected,
               rdmnet_ept_client_t,
               rdmnet_client_scope_t,
               const RdmnetClientConnectedInfo*,
               void*);
FAKE_VOID_FUNC(handle_ept_client_connect_failed,
               rdmnet_ept_client_t,
               rdmnet_client_scope_t,
               const RdmnetClientConnectFailedInfo*,
               void*);
FAKE_VOID_FUNC(handle_ept_client_disconnected,
               rdmnet_ept_client_t,
               rdmnet_client_scope_t,
               const RdmnetClientDisconnectedInfo*,
               void*);
FAKE_VOID_FUNC(handle_ept_client_client_list_update_received,
               rdmnet_ept_client_t,
               rdmnet_client_scope_t,
               client_list_action_t,
               const RdmnetEptClientList*,
               void*);
FAKE_VOID_FUNC(handle_ept_client_data_received,
               rdmnet_ept_client_t,
               rdmnet_client_scope_t,
               const RdmnetEptData*,
               RdmnetSyncEptResponse*,
               void*);
FAKE_VOID_FUNC(handle_ept_client_status_received,
               rdmnet_ept_client_t,
               rdmnet_client_scope_t,
               const RdmnetEptStatus*,
               void*);
