...
/*! \file rdmnet/rdmcontroller.h
 *  \brief Contains functions for creating RDM commands and unpacking
 *         responses.
 *  \author Sam Kearney */
#ifndef _RDMCONTROLLER_H_
#define _RDMCONTROLLER_H_
