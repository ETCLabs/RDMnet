...
/*! \file rdmnet/rdmresponder.h
 *  \brief Contains functions for unpacking RDM commands and creating
 *         responses.
 *  \author Sam Kearney */
#ifndef _RDMRESPONDER_H_
#define _RDMRESPONDER_H_
