...
etcpal_error_t BrokerResponder::ProcessPacket(const RdmBufferConstRef& buffer_in, RdmBufferRef& buffer_out,
...
etcpal_error_t BrokerResponder::ProcessGetDeviceLabel(RdmPdString& label, rdmresp_response_type_t& response_type,
                                                      rdmpd_nack_reason_t& nack_reason)
{
  return kEtcPalErrNotImpl;  // TODO: Not yet implemented
}

etcpal_error_t BrokerResponder::ProcessSetDeviceLabel(const RdmPdString& label, rdmresp_response_type_t& response_type,
                                                      rdmpd_nack_reason_t& nack_reason)
{
  return kEtcPalErrNotImpl;  // TODO: Not yet implemented
}
...
etcpal_error_t BrokerResponder::ProcessGetIdentifyDevice(bool& identify_state, rdmresp_response_type_t& response_type,
                                                         rdmpd_nack_reason_t& nack_reason)
{
  return kEtcPalErrNotImpl;  // TODO: Not yet implemented
}

etcpal_error_t BrokerResponder::ProcessSetIdentifyDevice(bool identify, rdmresp_response_type_t& response_type,
                                                         rdmpd_nack_reason_t& nack_reason)
{
  return kEtcPalErrNotImpl;  // TODO: Not yet implemented
}
...
etcpal_error_t BrokerResponder::ProcessGetBrokerStatus(RdmPdBrokerStatus& status, rdmresp_response_type_t& response_type,
                                                       rdmpd_nack_reason_t& nack_reason)
{
  return kEtcPalErrNotImpl;  // TODO: Not yet implemented
}
