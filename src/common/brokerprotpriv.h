...
/*! \file brokerprotpriv.h
 *  \brief Functions and definitions for Broker PDU messages that are only used
 *         internally.
 *  \author Sam Kearney
 */
#ifndef _BROKERPROT_PRIV_H_
#define _BROKERPROT_PRIV_H_

#include "lwpa_error.h"
#include "rdmnet/brokerprot.h"
#include "rdmnetconnpriv.h"
