...
DEFINE_FAKE_VALUE_FUNC(size_t, broker_get_ept_client_list_buffer_size, const RdmnetEptClientEntry*, size_t);
DEFINE_FAKE_VALUE_FUNC(size_t, broker_get_uid_assignment_list_buffer_size, size_t);

DEFINE_FAKE_VALUE_FUNC(size_t, broker_pack_connect_reply, uint8_t*, size_t, const EtcPalUuid*,
...
DEFINE_FAKE_VALUE_FUNC(etcpal_error_t, broker_send_connect_reply, rdmnet_conn_t, const EtcPalUuid*,
                       const BrokerConnectReplyMsg*);
...
DEFINE_FAKE_VALUE_FUNC(etcpal_error_t, broker_send_fetch_uid_assignment_list, rdmnet_conn_t, const EtcPalUuid*,
                       const RdmUid*, size_t);
