...
DEFINE_FAKE_VALUE_FUNC(etcpal_error_t, rc_llrp_manager_module_init);
...
DEFINE_FAKE_VOID_FUNC(rc_llrp_manager_data_received, const uint8_t*, size_t, const RdmnetMcastNetintId*);
