...
void rdmnet_core_discovery_reset_all_fakes(void)
{
  RESET_FAKE(rdmnet_disc_init_broker_info);
  RESET_FAKE(rdmnet_disc_start_monitoring);
  RESET_FAKE(rdmnet_disc_stop_monitoring);
  RESET_FAKE(rdmnet_disc_stop_monitoring_all);
  RESET_FAKE(rdmnet_disc_register_broker);
  RESET_FAKE(rdmnet_disc_unregister_broker);
}
